...
this.state = {
    ...
    return (
			<div className="big-container">
                ...
                <input className="w-96 px-5 h-8 font-semibold border border-slate-300 text-black rounded" type="text" onChange={this.handleTaskDescriptionChange} placeholder="Votre tache"></input>
